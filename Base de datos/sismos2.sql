...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-07-2018 a las 08:01:41
...
CREATE TABLE IF NOT EXISTS `deleg_mun` (
  ...
  KEY `fk_Delegacion_Estados1_idx` (`Estados_idEstados`)
...
INSERT INTO `deleg_mun` (`idDelegacion`, `nombre_delegacion`, `Estados_idEstados`) VALUES
(1, 'Álvaro Obregón', 7),
(2, 'Azcapotzalco', 7),
(3, 'Benito Juárez', 7),
(4, 'Coyoacán', 7),
(5, 'Cuajimalpa de Morelos', 7),
(6, 'Cuauhtémoc', 7),
(7, 'Gustavo A. Madero', 7),
(8, 'Iztacalco', 7),
(9, 'Iztapalapa', 7),
(10, 'Magdalena Contreras', 7),
(11, 'Miguel Hidalgo', 7),
(12, 'Milpa Alta', 7),
(13, 'Tláhuac', 7),
(14, 'Tlalpan', 7),
(15, 'Venustiano Carranza', 7),
(16, 'Xochimilco', 7);
...
CREATE TABLE IF NOT EXISTS `vivienda` (
  ...
  KEY `fk_Vivienda_Zona1_idx` (`Zona_idZona`)
...
ALTER TABLE `deleg_mun`
  ADD CONSTRAINT `fk_Delegacion_Estados1` FOREIGN KEY (`Estados_idEstados`) REFERENCES `estados` (`idEstados`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE `vivienda`
  ...
  ADD CONSTRAINT `fk_Vivienda_Zona1` FOREIGN KEY (`Zona_idZona`) REFERENCES `zona` (`idZona`) ON DELETE NO ACTION ON UPDATE NO ACTION;
